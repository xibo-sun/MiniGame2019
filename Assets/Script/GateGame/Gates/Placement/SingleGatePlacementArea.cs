...
namespace GateGame.Gates.Placement
{
    /// <summary>
    /// An area suitable for placing a single tower
    /// </summary>
    [RequireComponent(typeof(Collider))]
    public class SingleGatePlacementArea : MonoBehaviour, IPlacementArea
    {
        /// <summary>
        ...
        public GateFitStatus Fits(IntVector2 gridPos, IntVector2 size)
        {
            return m_IsOccupied ? GateFitStatus.Overlaps : GateFitStatus.Fits;
        }
        ...
        /// <summary>
        /// return the bool which represents if the area is occupied
        /// </summary>
