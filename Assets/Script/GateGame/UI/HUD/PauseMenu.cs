...
using GateGame.Game;
using Core.Game;
using GameUIState = GateGame.UI.HUD.GameUI.State;
...
namespace GateGame.UI.HUD
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        public void OpenPauseMenu()
        {
            ...
            //}
            GetComponent<PauseMenuGUI>().pauseButton.FireClick(true);
            GetComponent<PauseMenuGUI>().pauseButton.onClick.Call();
        ...
        public void ClosePauseMenu()
        {
            ...
            GetComponent<PauseMenuGUI>().pauseWindow.Hide();
